        ...
        <div className="bg-white py-8 px-6 sm:px-10 shadow-sm border border-black/5 rounded-3xl animate-scale-in">
          ...
          <div className="mt-7 pt-6 border-t border-black/5">
            <button
              ...
              className="w-full p-3 bg-blue-50/60 hover:bg-blue-100/70 border border-blue-100 rounded-2xl text-left transition-colors flex items-center justify-between"
            >
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-xl bg-blue-100 text-[#1173d4] flex items-center justify-center">
          ...
          <div className="mt-6 pt-5 border-t border-black/5 text-center">
            <Link
              to="/staff"
              className="inline-flex items-center gap-1.5 text-xs text-[#86868B] hover:text-[#1173d4] transition-colors"
            >
              <Shield className="w-3.5 h-3.5 text-[#1173d4]" />
              <span>Panitia atau Pengelola Event?</span>
              <span className="font-semibold text-[#1173d4] underline">Masuk ke Portal Staff ➔</span>
            </Link>
          </div>
        </div>
